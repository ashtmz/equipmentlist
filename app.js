...
function renderPrintSummary(summaryItems) {
...
function renderSelected() {
  ...
  const projectHistory = project ? getProjectHistoryEntries(project.name) : [];
      ...
      <section class="panel">
        <div class="section-head">
          ...
          <div class="section-head-actions">
            <button class="mini-button" data-action="export-overall-result-pdf" ${(state.selectionProjects.length === 0 && state.history.length === 0) ? "disabled" : ""}>全体リザルトPDF</button>
      ...
      <section class="panel">
        <div class="section-head">
          ...
          <div class="selection-workspace-actions">
            ...
            <button class="ghost-button" data-action="export-checkout-pdf" data-project-id="${escapeHTML(project.id)}" ${projectHistory.length === 0 ? "disabled" : ""}>持ち出し表PDF</button>
